...
IFE	REALIO-1,<
	STY	KIMY>		;PRESERVE Y.
IFE	REALIO-4,<ORAI	$80>	;TURN ON B7 FOR APPLE.
IFN	REALIO,<
OUTLOC: JSR	OUTCH>		;OUTPUT THE CHARACTER.
IFE	REALIO-1,<
	LDY	KIMY>		;GET Y BACK.
IFE	REALIO-2,<REPEAT	4,<NOP>>
IFE	REALIO-4,<ANDI	$7F>	;GET [A] BACK FROM APPLE.
...
READ:	LDXY	DATPTR		;GET LAST DATA LOCATION.
	XWD	$200,$A9	;LDAI TYA TO MAKE IT NONZERO.
IFE	BUFPAG,<
INPCON: >
	TYA
IFN	BUFPAG,<
...
STRCMP: CLR	VALTYP		;RESULT WILL BE NUMERIC.
	...
	LDAI	$FF		;GET A MINUS 1 FOR NEGATIVES.
...
GETCMP: LDADY	ARGMO		;GET NEXT CHAR TO COMPARE.
	...
	LDXI	$FF		;SET A POSITIVE DIFFERENCE.
...
DOCMP:	INX			;-1 TO 1, 0 TO 2, 1 TO 4.
	...
	AND	DOMASK
	BEQ	GOFLOT
	LDAI	$FF		;MAP 0 TO 0. ALL OTHERS TO -1.
...
FADDA:	LDYI	0
	STY	FACOV
FADD1:	CMPI	256-7		;FOR SPEED AND NECESSITY.  GETS
...
FDIVT:	BEQ	DV0ERR		;CAN'T DIVIDE BY ZERO !
	...
	BEQ	GOOVER		;OVERFLOW.
	LDXI	256-3-ADDPRC	;SETUP PROCEDURE.
	LDAI	1
...
BIGGES: JSR	QINT
	...
	ADCI	$FF		;NUMBER OF PLACES BEFORE DECIMAL POINT.
	TAX			;PUT INTO ACCX.
